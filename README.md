...
![Workflow status](https://img.shields.io/github/actions/workflow/status/serbanghita/Mobile-Detect/4.9.x-test.yml?style=flat-square)
...
There are four branches of MobileDetect.
`4.9.x` is the main version that is ALWAYS going to be updated first.
...
| 4.8.x   | [![8x](https://img.shields.io/github/actions/workflow/status/serbanghita/Mobile-Detect/4.8.x-test.yml?style=flat-square)](https://github.com/serbanghita/Mobile-Detect/actions/workflows/test.yml)  | `Detection\MobileDetect`        | [4.8](https://github.com/serbanghita/Mobile-Detect/tree/4.8.x)   | \>=8.0      | Maintenance          |
| 4.9.x   | [![8x](https://img.shields.io/github/actions/workflow/status/serbanghita/Mobile-Detect/4.9.x-test.yml?style=flat-square)](https://github.com/serbanghita/Mobile-Detect/actions/workflows/test.yml)  | `Detection\MobileDetect`        | [4.9](https://github.com/serbanghita/Mobile-Detect/tree/4.9.x)   | \>=8.0      | Current, **Recommended** |
